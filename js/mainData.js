...
const mainData = () => {
    ...
    const renderAnimeList = (array, ganres) => {
        // Находим элемент с классом "product" и вложенным элементом с классом "col-lg-8" и сохраняем его в переменную wrapper
    ...
    fetch('https://anime-date-fbec3-default-rtdb.firebaseio.com/anime.json')
        ...
        .then((data) => {
            ...
            // Вызываем функцию renderAnimeList для отображения списка аниме по жанрам
...
// Вызываем функцию mainData для начала работы с данными и отображения на странице
mainData();
